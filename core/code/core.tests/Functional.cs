...
public class OptionExtensionsTests
{
    ...
    {
        // Arrange
        var value = GenExtensions.GenerateDefault<string>().Sample();
        var option = Option<string>.Some(value);
        var errorMessage = GenExtensions.GenerateDefault<string>().Sample();
...
public class IAsyncEnumerableExtensionsTests
{
    ...
    {
        var arbitrary = GenExtensions.GenerateDefault<string>()
                                     .ListOf()
                                     .ToArbitrary();
